                    ...
                    <Col xl={4} lg={4} md={6}>
                        ...
                        <div className="postbox mb-25">
                            <div className="postbox__thumb">
                                <Link to="#">
                                    <img src={CategoryNewsImg1} alt="hero image"/>
                                </Link>
                            </div>
                            <div className="postbox__text pt-20">
                                <h4 className="title-18 pr-0">
                                    <Link to="#">Mustify Winner Is Rtired Because of Weaths Bads Ankle World Wide.</Link>
                                </h4>
                        ...
                        <div className="cat-sm-post">
                            <div className="post__small mb-30">
                                <div className="post__small-thumb f-left">
                                    <Link to="#">
                                        <img src={CategoryNewsImg2} alt="hero image"/>
                                    </Link>
                                </div>
                            ...
                            <div className="post__small mb-30">
                                <div className="post__small-thumb f-left">
                                    <Link to="#">
                                        <img src={CategoryNewsImg3} alt="hero image"/>
                                    </Link>
                                </div>
                                <div className="post__small-text fix pl-10">
                                    <h4 className="title-16 pr-0 mt-0">
